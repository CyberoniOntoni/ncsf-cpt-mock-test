...
QUESTIONS = [
    ...
    {"q": "Cardiac output equals stroke volume times what?", "a": "Heart rate", "exp": "CO = SV × HR is the fundamental cardiac output equation.", "wrong": ["Peripheral resistance", "Ejection fraction", "Blood viscosity"]},
    ...
    {"q": "Following high-intensity exercise, a client has burned additional calories. This phenomenon is termed:", "a": "EPOC (Excess post-exercise oxygen consumption)", "exp": "EPOC reflects elevated metabolism and oxygen consumption after intense exercise."},
