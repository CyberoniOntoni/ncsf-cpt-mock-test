...
Source: `web/questions.js` (415 questions).
...
| Quadratus lumborum | Trunk | 3 | `quadratus-lumborum.png` |
| Teres minor | Rotator cuff | 3 | `teres-minor.png` |
| Vastus intermedius | Quadriceps | 3 | `vastus-intermedius.png` |
| Vastus lateralis | Quadriceps | 3 | `vastus-lateralis.png` |
| Vastus medialis | Quadriceps | 3 | `vastus-medialis.png` |
| Biceps brachii | Upper arm | 2 | `biceps-brachii.png` |
| Gluteal | Hip / glute | 2 | `gluteal.png` |
| Tibialis anterior | Lower leg | 2 | `tibialis-anterior.png` |
| Adductor magnus | Hip group | 1 | `adductor-magnus.png` |
| Calves | Lower leg | 1 | `calves.png` |
| External oblique | Trunk | 1 | `external-oblique.png` |
| Gluteus minimus | Hip / glute | 1 | `gluteus-minimus.png` |
| Semimembranosus | Hamstrings | 1 | `semimembranosus.png` |
| Semitendinosus | Hamstrings | 1 | `semitendinosus.png` |
| Tensor fasciae latae | Hip / glute | 1 | `tensor-fasciae-latae.png` |
| TFL (tensor fasciae latae) | Hip / glute | 1 | `tfl-tensor-fasciae-latae.png` |
...
**Rotator cuff**
- Q16 question: All of the following are rotator cuff muscles, except:
- Q16 explanation: ...ris make up the musculature of the rotator cuff; often easily remembered through the acronym “SITS”. T...
- Q16 explanation: ...ris make up the musculature of the rotator cuff; often easily remembered through the acronym “SITS”. T...
- Q25 question: ...angle; reducing involvement of the rotator cuff?
...
**Supraspinatus**
- Q16 option 4: supraspinatus
- Q16 explanation: The supraspinatus, infraspinatus, teres minor, and subscapularis make up...
- Q25 explanation: ...cuff activation; specifically the supraspinatus. NCSF Manual reference: Ch. 2 (Functional Anatomy and...
- Q27 option 2: supraspinatus

**Subscapularis**
- Q16 option 3: subscapularis
- Q16 explanation: ...s, infraspinatus, teres minor, and subscapularis make up the musculature of the rotator cuff; often eas...
- Q113 option 4: subscapularis
- Q113 explanation: ...lustrated specifically targets the subscapularis. The subscapularis is a rotator cuff muscle responsibl...

**Infraspinatus**
- Q16 option 2: infraspinatus
- Q16 explanation: The supraspinatus, infraspinatus, teres minor, and subscapularis make up the musculatur...
- Q21 option 4: infraspinatus
- Q21 explanation: ...example exercise: seated row). The infraspinatus extends and externally rotates the humerus (example ex...
...
**Deltoid**
- Q21 option 3: deltoid
- Q21 explanation: The deltoid is predominantly responsible for shoulder abduction (m...
- Q25 question: The deltoid becomes the primary abductor of the humerus beginning...
- Q25 explanation: ...is point, neural activation of the deltoid (specifically the medial head) will be diminished and...
...
**Pectoralis major**
- Q22 option 1: concentric contraction of the pectoralis major
- Q47 explanation: ...shoulder horizontal adduction. The pectoralis major anchors to the clavicle and sternum and pulls the hume...
- Q52 option 1: pectoralis major
- Q113 option 1: pectoralis major
...
**Triceps**
- Q13 explanation: ...nt would negate the focus from the triceps musculature. A common fault during triceps exercises i...
- Q13 explanation: ...nt would negate the focus from the triceps musculature. A common fault during triceps exercises i...
- Q52 question: ..._______ to relax when performing a triceps push-down.
- Q52 explanation: ...e biceps brachii to relax during a triceps push-down. Reciprocal inhibition is the process by whi...
...
- Q52 explanation: Reciprocal inhibition causes the biceps brachii to relax during a triceps push-down. Reciprocal inhibi...
...
**Latissimus dorsi**
- Q22 option 4: eccentric contraction of the latissimus dorsi
- Q40 option 1: Latissimus dorsi
- Q40 explanation: ...es shoulder complex elevation. The latissimus dorsi is responsible for humeral adduction. NCSF Manual refe...
- Q52 option 3: latissimus dorsi

**Rhomboids**
- Q19 option 2: rhomboids
- Q21 explanation: ...during the lateral side raise. The rhomboids retract, rotate and fix the scapula in place (example...
- Q22 option 2: concentric contraction of the rhomboids
- Q22 explanation: Concentric contraction of the rhomboids will cause the scapulae to retract, as seen during the...
...
| Term | Mentions | Q | O | E | Question IDs |
| --- | ---: | ---: | ---: | ---: | --- |
| Levator scapulae | 3 | 0 | 2 | 1 | 16, 21 |

### Sample contexts

**Levator scapulae**
- Q16 option 1: levator scapulae
- Q21 option 2: levator scapulae
- Q21 explanation: ...cise: external band rotation). The levator scapulae is an assistive mover during a number of exercises inv...
...
**Hip flexors**
- Q17 explanation: ...nd 30 degrees results in increased hip flexor activation as seen when performing full sit-ups. Ancho...
- Q17 explanation: ...nd 30 degrees results in increased hip flexor activation as seen when performing full sit-ups. Ancho...
...
**Glutes**
- Q18 explanation: The quadriceps and glutes provide the main effort for hip and knee extension dur...
- Q18 explanation: The quadriceps and glutes provide the main effort for hip and knee extension du...
- Q28 option 4: pre-stretch the quadriceps and the glutes
- Q30 explanation: ...res more hip extension, so it is a glute-dominant exercise with support of the hamstrings and q...
...
**Quadriceps**
- Q14 question: ...t is the dual-action muscle of the quadriceps; allowing it to act upon both the hip and knee joints?
- Q14 explanation: The quadriceps is comprised of four different muscles; the vastus lat...
- Q14 explanation: The quadriceps is comprised of four different muscles; the vastus lat...
- Q14 explanation: The quadriceps is comprised of four different muscles; the vastus lat...

**Rectus femoris**
- Q14 option 2: rectus femoris
- Q14 explanation: ...s medialis, vastus intermedius and rectus femoris. The rectus femoris is the only quadriceps muscle that...
- Q14 explanation: ...s medialis, vastus intermedius and rectus femoris. The rectus femoris is the only quadriceps muscle that...
- Q14 explanation: ...s medialis, vastus intermedius and rectus femoris. The rectus femoris is the only quadriceps muscle that...

**Vastus intermedius**
- Q14 option 1: vastus intermedius
- Q14 explanation: ...vastus lateralis, vastus medialis, vastus intermedius and rectus femoris. The rectus femoris is the only qua...
- Q19 explanation: ...rectus femoris, vastus lateralis, vastus intermedius and vastus medialis are all part of the quadriceps; fu...

**Vastus lateralis**
- Q14 option 4: vastus lateralis
- Q14 explanation: ...sed of four different muscles; the vastus lateralis, vastus medialis, vastus intermedius and rectus femori...
- Q19 explanation: ...emitendinosus. The rectus femoris, vastus lateralis, vastus intermedius and vastus medialis are all part o...
...
**Hamstrings**
- Q18 explanation: ...ding the knee during the lift. The hamstrings function secondarily while the adductors and abductors...
- Q19 option 1: hamstrings
- Q19 explanation: The hamstring muscle group includes the biceps femoris, semimembrano...
- Q19 explanation: The hamstring muscle group includes the biceps femoris, semimembrano...
...
**Semitendinosus**
- Q19 explanation: ...iceps femoris, semimembranosus and semitendinosus. The rectus femoris, vastus lateralis, vastus intermed...
...
**Gastrocnemius**
- Q43 question: ...wants to increase the size of his gastrocnemius, what exercise would you recommend?
- Q43 explanation: ...ppropriate exercise to isolate the gastrocnemius would be the standing calf raise. The gastrocnemius is...
- Q43 explanation: ...ppropriate exercise to isolate the gastrocnemius would be the standing calf raise. The gastrocnemius is...
- Q43 explanation: ...ppropriate exercise to isolate the gastrocnemius would be the standing calf raise. The gastrocnemius is...
