...
export const ASSESSMENT_TEMPLATES: AssessmentTemplateDef[] = [
  {
    ...
    fields: [
      ...
      },
      {
        ...
        type: "pass_fail",
        help: "Fail/pain → avoid forcing IR/ER under load; screen red flags",
      },
    ],
  ...
  },
  {
    ...
    fields: [
      ...
      },
      {
        ...
        type: "pass_fail",
        help: "Pass = stable tracking over mid-foot; fail = clear collapse",
      },
      {
        key: "heels",
        label: "Heels rise?",
        type: "pass_fail",
        help: "Fail if heels leave the floor to hit depth",
      },
      {
        key: "arms_fall",
        label: "Arms fall forward?",
        type: "pass_fail",
        help: "Fail if arms drop well in front of the ears",
      },
      {
        key: "notes",
        label: "Coach notes",
        type: "text",
        help: "e.g. trunk lean, asymmetry, cue that fixed it",
      },
    ],
  ...
  },
  {
    ...
    fields: [
      ...
      },
      {
        ...
        type: "pass_fail",
        help: "Fail if heel cannot stay down in a usable range",
      },
      {
        key: "notes",
        label: "Coach notes",
  ...
  },
  {
    ...
    fields: [
      ...
      },
      {
        ...
        type: "pass_fail",
        help: "Fail if strategy is obviously unstable",
      },
      {
        key: "notes",
        label: "Coach notes",
