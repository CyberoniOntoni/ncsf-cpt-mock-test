...
5. **Complete session**:
   - Burns **one pack session** when a pack is **active** (oldest pack first). Calendar Done / reopen do **not** burn or restore.
...
- [ ] Calendar **Close booking** / **Done** does not drop pack; **Reopen** does not restore  
